defmodule ForgeWeb.ProjectLive.Components.Kpis do
  ...
  @spec mini_kpi(map()) :: Phoenix.LiveView.Rendered.t()
  ...
  @spec mini_kpi_border(String.t()) :: String.t()
  ...
  @spec mini_kpi_bg(String.t()) :: String.t()
  ...
  @spec mini_kpi_text(String.t()) :: String.t()
